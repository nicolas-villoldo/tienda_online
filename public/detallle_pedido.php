...
<body>
    ...
    <div class="container">
        ...
        <!-- CARRITO Y FORMULARIO (ESTE ES EL QUE QUERÍAS VER SIEMPRE) -->
        <div class="carrito-sidebar">
            ...
            <!-- FORMULARIO DE DATOS: Visible SIEMPRE -->
            <form action="tienda/procesar_pago.php" method="POST">
                ...
                <!-- Botón Verde. Se deshabilita si no hay nada en el carrito -->
